...
private val BASE_EN: Map<String, String> = mapOf(
    ...
    "app.bootIntro.set" to "Boot intro set. It plays next time the app starts.",
    ...
    "ra.settings.help.global" to "The default for every game. To use RetroAchievements in only some games, turn it off here and on in those games' own settings.",
    "ra.settings.help.game" to "This game only. It outranks the global setting, so this is how to use RetroAchievements in some games and not others.",
    "ra.settings.openScreen.description" to "Your account, hardcore mode and notifications.",
