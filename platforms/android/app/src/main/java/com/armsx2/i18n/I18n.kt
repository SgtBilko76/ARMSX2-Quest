...
private val BASE_EN: Map<String, String> = mapOf(
    ...
    "pad.onScreenControls.description" to "On-screen touch buttons. Never: hidden, for devices with built-in controls. 1–10s: hide after that long without a touch. Auto: show on touch, hide when you use a controller. Always: never hide, for playing with a controller and the touch buttons together.",
