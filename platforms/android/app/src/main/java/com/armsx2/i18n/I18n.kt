...
val EN: Map<String, String> = mapOf(
    ...
    "pad.analogExtra.description" to "Adds a button just above the on-screen left stick. Slide your thumb up onto it without lifting off — you keep steering while it's held, so running forward and sprinting is one motion. Useful for sprint (GTA, Silent Hill) and jump (God of War, Kingdom Hearts).",
    ...
    "pad.analogExtra.distance" to "Extra button distance",
    "pad.analogExtra.distance.description" to "How far above the stick the button sits, as a percentage of the stick's radius. Lower is an easy thumb roll; higher needs a deliberate reach.",
    "renderer.overlayArt.import" to "Import overlay pack (.zip or image)",
